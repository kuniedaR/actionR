...
const float DebugCamera::DEFAULT_CAMERA_DISTANCE = 12.0f;
...
void DebugCamera::Update()
{
	...
	////カメラの操作
	//static Keyboard::KeyboardStateTracker m_tracker;
	//Keyboard::State kb = Keyboard::Get().GetState();

	//m_vec = Vector3(0.05f, 0.05f, 0.05f);
